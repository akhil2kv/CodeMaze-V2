...
namespace Service.Contracts
{
    ...
    {
        Task<(IEnumerable<ExpandoObject> employees,MetaData metadata)> GetAllEmployeesAsync(Guid companyId, EmployeeParameters employeeParameters, bool trackChanges);
